    ...
    public partial class FrmRemoteIO : Form,IChildMsg
    {
        ...
        private void btnSetAddr_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string er = string.Empty;
                if (_devIO.SetAddr(System.Convert.ToInt32(txtSetAddr.Text), out er))
                {
        ...
        private void btnReadAddr_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int rData = 0;
                string er = string.Empty;
                if (_devIO.ReadAddr(out rData, out er))
                {
        ...
        private void btnSetBaud_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string er = string.Empty;
                if (_devIO.SetBaud(System.Convert.ToInt32(txtAddr.Text), System.Convert.ToInt32(txtSetBaud.Text), out er))
                {
        ...
        private void btnReadBaud_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int rData = 0;
                string er = string.Empty;
                if (_devIO.ReadBaud(System.Convert.ToInt32(txtAddr.Text), out rData, out er))
                {
                    if (rData > 57600)
                        rData = 115200;
        ...
        private void btnReadVer_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int rData = 0;
                string er = string.Empty;
                if (_devIO.ReadVersion(System.Convert.ToInt32(txtAddr.Text), out rData, out er))
                {
        ...
        private void btnReadErr_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int rData = 0;
                string er = string.Empty;
                if (_devIO.ReadErrCode(System.Convert.ToInt32(txtAddr.Text), out rData, out er))
                {
        ...
        private void btnWrite_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (N < 2)
                {
                    ...
                    if (!_devIO.Write(devAddr, devType, startAddr, val, out er))
                    {
        ...
        private void btnRead_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int N = System.Convert.ToInt32(txtLen.Text);
                int[] rVal = new int[N];
                if (!_devIO.Read(devAddr,devType, startAddr, ref rVal, out er))
                {
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!loadDefault)
                {
                    MessageBox.Show("正在初始化PLC寄存器,请稍等.", "初始化", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
                ...
                {
                    MessageBox.Show(er, "错误提示", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!loadDefault)
                {
                    MessageBox.Show("正在初始化IO寄存器,请稍等.", "初始化", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
                ...
                if (btnRun.Text == "启动")
                {
                    ...
                    {
                        MessageBox.Show("没有可监控寄存器,", "监控寄存器", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        return;
                    }
        ...
        private void onBtn_Click(object sender, EventArgs e)
        {
            ...
            if (IOThread == null)
            {
                MessageBox.Show("请先启动监控,", "监控寄存器", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            if (idNo == -1)
            {
                MessageBox.Show("寄存器[" + des + "]不存在", "监控寄存器",
        ...
        private bool open(out string er)
        {
            ...
            try
            {
                ...
                _devIO = new CIOCom(_ioType);

                if (!_devIO.Open(comName, out er, comSetting))
                {
                    _devIO.Close();
                    _devIO = null;
                    return false;
                                  ...
                                  out List<CIOThread.CREG> wReg, out string er)
        {
            ...
            try
            {
                ...
                {
                    er = "找不到数据库文件[" + Path.GetFileName(dbFile) + "]";
                    return false;
                }
