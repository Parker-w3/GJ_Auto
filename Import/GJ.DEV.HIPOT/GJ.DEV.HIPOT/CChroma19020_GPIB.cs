...
{
    public class CChroma19020_GPIB:IHP
    {
      #region 构造函数
      public CChroma19020_GPIB(int idNo = 0, string name = "CChroma19020_GPIB")
      {
          this._idNo = idNo;
          this._name = "Chroma19020";          
      ...
      #region 字段
      private int _idNo = 0;
      private string _name = "CChroma19020_GPIB";
      private bool _conStatus = false;
      private Device com = null;
      /// <summary>
      /// 负载通道
      /// </summary>
      ...
      public bool Open(string comName, out string er, string setting = "9600,n,8,1")
      {
          ...
          try
          {
              ...
              com = new Device(boardNum, primaryAddress, secondaryAddress);
      ...
      /// <param name="er"></param>
      /// <returns></returns>
      public bool Init(out string er)
      {
          er = string.Empty;
