...
namespace GJ.COM
{
    ...
    public class CLanguage
    {
        ...
        /// <returns></returns>
        private static string SimplifiedToTraditional(string Text)
        {
        ...
        private static string TraditionalToSimplified(string Text)
        {
            ...
            string converText = Microsoft.VisualBasic.Strings.StrConv(Text, Microsoft.VisualBasic.VbStrConv.SimplifiedChinese, new System.Globalization.CultureInfo("zh-cn").LCID);
        ...
        private static string ConvertBig5(string Text)
        {
            string result = Text;
            try
            {
