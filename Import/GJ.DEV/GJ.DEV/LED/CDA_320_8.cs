...
{
    public class CDA_320_8:ILED
    {
        #region 构造函数
        public CDA_320_8(int idNo, string name)
        {
            this._idNo = idNo;
            this._name = name;
        }
      ...
      */
        ...
        /// <returns></returns>
        private bool SendCmdToERS272(string wData, int rLen, out string rData, out string er, int wTimeOut = 1000)
        {
            rData = string.Empty;
            er = string.Empty;
            try
