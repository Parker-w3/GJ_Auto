...
namespace GJ.DEV.FCMB
{
    ...
    public interface IFCMB
    {
        ...
        /// <param name="er"></param>
        /// <returns></returns>
        bool ReadChildVersion(int addr, out List<int> childVer, out string er);
        /// <summary>
        /// 快充模式配置D8007
        /// </summary>
        /// <param name="addr"></param>
        ...
        /// <param name="er"></param>
        /// <returns></returns>
        bool SetQCM(int addr, EQCM qcm, double qcv, double qci, out string er);
        /// <summary>
        /// 快充模式配置D800
        /// </summary>
        /// <param name="addr"></param>
        ...
        /// <param name="er"></param>
        /// <returns></returns>
        bool SetACON(int addr, int wOnOff, out string er);
        /// <summary>
        /// 读取时序开关D806F
        /// </summary>
        /// <param name="addr"></param>
        ...
        /// <param name="er"></param>
        /// <returns></returns>
        bool ReadVolt(int addr, out List<double> volt, out string er,bool sync=true);
        /// <summary>
        /// 读取AC电压
        /// </summary>
        /// <param name="addr"></param>
