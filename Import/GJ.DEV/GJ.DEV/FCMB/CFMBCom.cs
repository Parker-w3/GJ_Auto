...
namespace GJ.DEV.FCMB
{
    public class CFMBCom
    {
      ...
      /// <param name="er"></param>
      /// <returns></returns>
      public bool ReadChildVersion(int addr, out List<int> childVer, out string er)
      {
          return _devFCMB.ReadChildVersion(addr, out childVer, out er);  
      }
      /// <summary>
      /// 快充模式配置D8007
      /// </summary>
      ...
      /// <param name="er"></param>
      /// <returns></returns>
      public bool SetQCM(int addr, EQCM qcm,double qcv,double qci, out string er)
      {
          return _devFCMB.SetQCM(addr, qcm, qcv, qci,out er);
      }
      /// <summary>
      /// 快充模式配置D8007
      /// </summary>
      ...
      {
          return _devFCMB.SetACON(addr, wOnOff, out er); 
      }
      /// <summary>
      /// 读取时序开关D806F
      /// </summary>
      ...
      {
          return _devFCMB.ReadVolt(addr, out volt, out er, sync); 
      }
      /// <summary>
      /// 读取AC电压
      /// </summary>
