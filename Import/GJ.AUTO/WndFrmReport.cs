...
namespace GJ.AUTO
{
    public partial class WndFrmReport : Form,IMainMsg
    {
        #region 插件方法
        /// <summary>
        /// 子窗口
        ...
        #region 字段
        private static WndFrmReport dlg = null;
        ...
        /// 创建唯一实例
        /// </summary>
        public static WndFrmReport CreateInstance()
        {
            lock (syncRoot)
            {
                if (dlg == null || dlg.IsDisposed)
                {
                    dlg = new WndFrmReport();
                }
            }
            return dlg;
        }
        ...
        #region 面板回调函数
        private void WndFrmReport_Load(object sender, EventArgs e)
        {
        ...
        private void SetLanguage()
        {
            ...
            switch (CLanguage.languageType)
            {
                ...
                case CLanguage.EL.英语:
                    this.Text = "Test Data Query";
                    break;
                case CLanguage.EL.繁体 :
                    this.Text = CLanguage.Lan ("测试报表查询");
                    break;
                default:
                    break;
            }
