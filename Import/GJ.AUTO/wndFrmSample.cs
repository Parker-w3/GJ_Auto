...
namespace GJ.AUTO
{
    public partial class wndFrmSample : Form,IMainMsg
    {
        #region 插件方法
        /// <summary>
        /// 子窗口
        ...
        #region 字段
        private static wndFrmSample dlg = null;
        ...
        /// 创建唯一实例
        /// </summary>
        public static wndFrmSample CreateInstance()
        {
            lock (syncRoot)
            {
                if (dlg == null || dlg.IsDisposed)
                {
                    dlg = new wndFrmSample();
                }
            }
            return dlg;
        }
        ...
        #region 面板回调函数
        private void wndFrmSample_Load(object sender, EventArgs e)
        {
        ...
        private void SetLanguage()
        {
            ...
            switch (CLanguage.languageType)
            {
                ...
                case CLanguage.EL.英语:
                    this.Text = "Sample Fixture Setting";
                    break;
                case CLanguage.EL.繁体 :
                    this.Text = CLanguage.Lan("点检治具设置");
                    break;
                default:
                    break;
            }
