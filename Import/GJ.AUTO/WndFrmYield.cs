...
namespace GJ.AUTO
{
    public partial class WndFrmYield : Form,IMainMsg
    {
        #region 插件方法
        /// <summary>
        /// 子窗口
        ...
        #region 字段
        private static WndFrmYield dlg = null;
        ...
        /// 创建唯一实例
        /// </summary>
        public static WndFrmYield CreateInstance()
        {
            lock (syncRoot)
            {
                if (dlg == null || dlg.IsDisposed)
        ...
        #region 面板回调函数
        private void WndFrmYield_Load(object sender, EventArgs e)
        {
