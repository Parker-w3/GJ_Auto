...
namespace GJ.AUTO
{
    public partial class WndFrmSnQuery : Form,IMainMsg
    {
        #region 插件方法
        /// <summary>
        /// 子窗口
        ...
        #region 字段
        private static WndFrmSnQuery dlg = null;
        ...
        /// 创建唯一实例
        /// </summary>
        public static WndFrmSnQuery CreateInstance()
        {
            lock (syncRoot)
            {
                if (dlg == null || dlg.IsDisposed)
                {
                    dlg = new WndFrmSnQuery();
                }
            }
            return dlg;
        }
        ...
        #region 面板回调函数
        private void WndFrmSnQuery_Load(object sender, EventArgs e)
        {
        ...
        private void SetLanguage()
        {
            ...
            switch (CLanguage.languageType)
            {
                ...
                case CLanguage.EL.英语:
                    this.Text = "SerialNo Info Query";
                    break;
                case CLanguage.EL.繁体 :
                    this.Text = CLanguage.Lan("产品条码信息查询");
                    break;
                default:
                    break;
            }
