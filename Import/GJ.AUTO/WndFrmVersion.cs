...
namespace GJ.AUTO
{
    public partial class WndFrmVersion : Form,IMainMsg
    {
        #region 插件方法
        /// <summary>
        /// 子窗口
        ...
        #region 字段
        private static WndFrmVersion dlg = null;
        ...
        /// 创建唯一实例
        /// </summary>
        public static WndFrmVersion CreateInstance()
        {
            lock (syncRoot)
            {
                if (dlg == null || dlg.IsDisposed)
                {
                    dlg = new WndFrmVersion();
                }
            }
            return dlg;
        }
        ...
        #region 面板回调函数
        private void WndFrmVersion_Load(object sender, EventArgs e)
        {
        ...
        private void SetLanguage()
        {
            ...
            switch (CLanguage.languageType)
            {
                ...
                case CLanguage.EL.英语:
                    this.Text = "Software Version Record";
                    break;
