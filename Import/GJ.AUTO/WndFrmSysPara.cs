...
namespace GJ.AUTO
{
    public partial class WndFrmSysPara : Form,IMainMsg
    {
        #region 插件方法
        /// <summary>
        /// 子窗口
        ...
        {
            if (lPara==(int)ElPara.保存)
            {
                MessageBox.Show(CLanguage.Lan("系统参数保存成功"), CLanguage.Lan("系统参数"),
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else if (lPara==(int)ElPara.退出)
            {
                this.Close();
            }                     
        }
        ...
        #region 字段
        private static WndFrmSysPara dlg = null;
        ...
        /// 创建唯一实例
        /// </summary>
        public static WndFrmSysPara CreateInstance()
        {
            lock (syncRoot)
            {
                if (dlg == null || dlg.IsDisposed)
                {
                    dlg = new WndFrmSysPara();
                }
            }
            return dlg;
        }
        ...
        private void SetLanguage()
        {
            ...
            switch (CLanguage.languageType)
            {
                ...
                case CLanguage.EL.英语:
                    this.Text = "System Parameter Setting";
                    break;
                case CLanguage.EL.繁体 :
                    this.Text = CLanguage.Lan("系统参数配置");
                    break;
                default:
                    break;
            }
