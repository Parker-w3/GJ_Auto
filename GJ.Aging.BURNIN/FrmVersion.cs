...
namespace GJ.Aging.BURNIN
{
    public partial class FrmVersion : Form,IChildMsg 
    {
        ...
        private void SetUILanguage()
        {
            switch (GJ.COM.CLanguage.languageType)
            {
                ...
                case CLanguage.EL.繁体 :
                    ...
                    this.Text = CLanguage.Lan ("软件版本记录");
                    Column1.HeaderText =CLanguage.Lan ( "编号");
                    Column1.HeaderText = CLanguage.Lan ("日期");
                    Column1.HeaderText =CLanguage.Lan ( "内容");
                    Column1.HeaderText = CLanguage.Lan ("版本");
                    Column1.HeaderText =CLanguage.Lan ( "作者");
                    Column1.HeaderText = CLanguage.Lan ("等级");
                    label1.Text = CLanguage.Lan ("软件版本升级记录");
                    break;
                default:
                    break;
            }
        ...
        private void writeVersion()
        {
            ...
            ver.upDate = "2024/05/30";
            ver.upContext = CLanguage.Lan ( "常州光宝老化柜软件导入使用.");
            ver.upVer = "V1.0.0";
            ver.upAthour = "pf.xu";
            updateVer.Add(ver);
